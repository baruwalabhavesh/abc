...
$passphrase = 'scanflip';
$message = 'ScanFlip push notification!';
			...
			*/
			...
			if($Row_user['notification_setting']==1)
			{
				...
				{				
					...
					$expire_data_query = "SELECT t.id 'id',t.counter 'counter',tp.notification_type,t.time_10_flag,t.time_4_flag FROM notification t,notification_type tp where t.notification_type_id=tp.id and tp.id=1 and t.is_read=0 and t.customer_id=".$customer_id;
							...
							if($Row['time_10_flag']!=1)
							{
								...
								{									
									...
									if($Row['counter']!=0)
									{
										if($Row['counter']==1)
										{
											$message = $Row['counter']." campaign reserved by you is expiring today.";
											send_gcm_message($customer_id,$Row_user['gcm_registration_id'],$message,"expire_today");
										...
										{
											$message = $Row['counter']." campaigns reserved by you are expiring today.";
											send_gcm_message($customer_id,$Row_user['gcm_registration_id'],$message,"expire_today");
					...
					$new_data_query = "SELECT t.id 'id',t.counter 'counter',tp.notification_type,t.time_10_flag,t.time_4_flag FROM notification t,notification_type tp where t.notification_type_id=tp.id and tp.id=2 and t.is_read=0 and t.customer_id=".$customer_id;
							...
							if($Row['time_10_flag']!=1)
							{
								...
								{								
									...
									if($Row['counter']!=0)
									{
										if($Row['counter']==1)
										{
											$message = "Today ".$Row['counter']." new campaign is launched by scanflip merchant near by you.";
											send_gcm_message($customer_id,$Row_user['gcm_registration_id'],$message,"new_campaign");
										...
										{
											$message = "Today ".$Row['counter']." new campaigns were launched by scanflip merchants near by you.";
											send_gcm_message($customer_id,$Row_user['gcm_registration_id'],$message,"new_campaign");
								...
								if (((int) date('H', $currentTime)) >= 16) 
								{
									...
									if($Row['counter']!=0)
									{
										if($Row['counter']==1)
										{
											...
											$where['customer_id'] = $customer_id;
											$where['notification_type_id'] = 2;
											$u_array['time_4_flag'] = 1;
											$u_array['time_4_time'] = date("Y-m-d H:i:s");
											$objDB->Update($u_array, "notification", $where);
							...
							if($Row['time_10_flag']!=1)
							{
								...
								{									
									...
									if($Row['counter']!=0)
									{
										...
										{
											$message = $Row['counter']." campaign reserved by you is expiring today.";
											send_push_message($customer_id,$Row_user['device_id'],$message,"expire_today");
							...
							if($Row['time_10_flag']!=1)
							{
								...
								{								
									...
									if($Row['counter']!=0)
									{
										...
										{
											$message = "Today ".$Row['counter']." new campaign is launched by scanflip merchant near by you.";
											send_push_message($customer_id,$Row_user['device_id'],$message,"new_campaign");
