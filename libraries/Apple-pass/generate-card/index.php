...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['passenger'])){
	...
	$pass = new PKPass('CertificatesPass.p12', 'scanflip'); 
	//echo "a";
	// Add the WWDR certificate 
	$pass->setWWDRcertPath('wwdrPass.pem');
	//echo "b";
	...
	$pass->setJSON('{ 
	"passTypeIdentifier": "pass.com.lanetteam.scanflippass",
	"formatVersion": 1,
	"organizationName": "Scanflip",
	"serialNumber": "123456",
	"teamIdentifier": "AGK5BZEN3E",
	"backgroundColor": "rgb(107,156,196)",
	"logoText": "Scanflip - Powering smart savings from local merchants",
