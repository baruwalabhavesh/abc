...
<table cellspacing="0" cellpadding="0" style="width:100%; border:0;clear:both; margin:20px 0;">
  <tbody style="width:100%; display:inline-block;">
	...
	//$mail->AddAddress("lanetteam.sarvesh@gmail.com");
	//$mail->AddAddress("bhavesh.lanetteam@gmail.com");
	...
	$mail->Subject    = $client_msg['location_detail']['violates_subject'];
