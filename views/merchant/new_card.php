...
<body>
  ...
  <div class="maincontainer">
    <div class="notification notification-card-volume">Card volume can be numbers and cannot be 0 </div>
       ...
       <?php 
        if(isset($_POST['card_title'])){
         ...
         // $card_type= $_POST['card_type'];
          ...
          //$punch= $_POST['punch_per'];
          echo '<div class="title cardtitle_ellip">'.$title.'</div>';
          ...
          //$punch = $_POST['punch_per'];
          //echo '<div class="hidden" id="punch" value="'.$punch.'"></div>';
          
          $card_category=0;
          if(isset($_POST['card_category']))
			{
    ...
    <div style="display: none;" id="edit_card_form">
        <form>
         <div class="heading">Card Title:</div>
          ...
          <input type="text" class="form-control" maxlength="76" id="card_keyword" name="card_keyword" value="<?php if(isset($_POST['card_keyword'])){echo $_POST['card_keyword'];}else{echo '';} ?>">
          <p class="hint">3 keywords separated by commas | No HTML allowed</p>
          
          <div class="termsdiv">
            <div class="heading">Terms and Conditions:</div>
            <textarea name="terms_conditions" id="terms_conditions" class="form-control"><?php if(isset($_POST['terms_conditions'])){echo trim($_POST['terms_conditions']);}?></textarea>            
          </div>
      ...
      <div class="container_box clearfix">
        <div class="layout_box fleft">
          ...
          <div class="select_colors">
           ...
           <div class="row">
            ...
            <select name="" id="stamp_volume" class="form-control w150">
          ...
          <div class="row">
            <div class="text dib">Reward points per visit</div>
              <input type="text" id="reward_per_visit" class="dib form-control w150" placeholder="00 (optional)">
          ...
          <div class="row">
            ...
            <div class="row clearfix">
              <div class="fleft padv10">
                ...
                <select name="" id="stamp_image" class="select form-control w150">
                  <?
						...
						?>
							<option stampedimage="<?php echo $Row['stamped_image'] ?>" unstampedimage="<?php echo $Row['unstamped_image'] ?>" value="<?=$Row['id']?>"><?=$Row['name']?></option>
						<?
						}
						?>    
                </select>
              ...
              <!--<div class="fleft padv10">
                <p>Or upload your own images (stamps should  be 100px x 100px or smaller):</p>
                <div class="col-lg-6">
                  <div class="image_upload_button" id="unstamped_button">Unstamped</div>
                  <input type="file" accept=".jpg,.gif,.png" class="hidden"  id="unstamped">
                </div>
                <div class="col-lg-6">
                  <div class="image_upload_button" id="stamped_button">Stamped</div>
                  <input type="file" accept=".jpg,.gif,.png" id="stamped" class="hidden" >
        ...
        <div class="loyality_card_preview loyality_card_images  fleft" id="loyality">
          ...
          <div class="stamps_box">
            <div class="stamps_box6 clearfix">
              <div class="stamp stamped fleft"><img src="<?php echo ASSETS?>/loyalty/images/coffee-stamped.png"></div>
              <div class="stamp stamped fleft"><img src="<?php echo ASSETS?>/loyalty/images/coffee-stamped.png"></div>
              <div class="stamp stamped fleft"><img src="<?php echo ASSETS?>/loyalty/images/coffee-stamped.png"></div>
              <div class="stamp unstamped fleft"><img src="<?php echo ASSETS?>/loyalty/images/coffee-unstamped.png"></div>
              <div class="stamp unstamped fleft"><img src="<?php echo ASSETS?>/loyalty/images/coffee-unstamped.png"></div>
              <div class="stamp unstamped fleft"><img src="<?php echo ASSETS?>/loyalty/images/coffee-unstamped.png"></div>
            </div>  
          </div>
      ...
      <div class="container_box clearfix">
        <div class="switch_box fleft">
          <div class="row">
            ...
            <input type="text" id="reward_text" placeholder="Eg. You are entitled to Free coffee." maxlength="76" class="form-control ">
            <div class="hint"><span data-max="76">76</span> characters remaining</div>
            ...
            <div class="row">
              <div class="dib">Additional reward points</div> <input id="additional_reward_points" type="text" class="dib form-control w150" placeholder="00 (optional)"> 
              <div class="hint" style="margin-left:175px">numeric only</div>
            </div>
          </div>
        </div>
      ...
      <div class="container_box clearfix">
        ...
        <tbody>
          <?php 
            ...
            $sql='SELECT id,address,city,state,zip FROM locations where active=1 and created_by='.$_SESSION['merchant_id'];
            ...
            if($rs === false) {
              ...
              while (!$rs->EOF) {
                echo '<tr>';
                echo '<td><input type="checkbox" id="chk'.$rs->fields['id'].'" data-id="'.$rs->fields['id'].'"/></td>';
    ...
    <div class="companybox">
      ...
      <div class="container_box clearfix">
        <div class="company_box fleft">
          ...
          <div class="col-lg-3">
            <div class="cards_left">Cards left: <span>0</span></div>
          </div>
          <div class="col-lg-3">
  ...
  <?php
	...
	?>
  <form action="process_card.php" id="form_to_process" class="hidden">
    <input type="hidden" value="-1" name="card_id_val" id="card_id_val">
    <input type="hidden" value="" name="card_title_val" id="card_title_val">
    <input type="hidden" value="" name="card_type_val" id="card_type_val">
    <input type="hidden" value="" name="punch_type_val" id="punch_type_val">
    <input type="hidden" value="" name="text_color_val" id="text_color_val">
    <input type="hidden" value="" name="background_color_val" id="background_color_val">
    <input type="hidden" value="" name="reward_per_visit_val" id="reward_per_visit_val">
    <input type="hidden" value="" name="reward_title_val" id="reward_title_val">
    <input type="hidden" value="" name="reward_points_val" id="reward_points__val">
    <input type="hidden" value="" name="reward_image_val" id="reward_image_val">
    <input type="hidden" value="" name="participating_locations_val" id="participating_locations_val">
    <input type="hidden" value="" name="card_status_val" id="card_status_val">
    <input type="hidden" value="" name="number_stamps_val" id="number_stamps_val">
    <input type="hidden" value="" name="card_volume_val" id="card_volume_val">
    <input type="hidden" value="" name="redeemption_limit_val" id="redeemption_limit_val">
    <input type="hidden" value="" name="json_val" id="json_val">
    ...
    ?>
    <input type="hidden" name="hdn_title" id="hdn_title" value="<?php echo $cardtitle ?>" />
  </form>
     ...
     jQuery('#edit_card_form #close_card_form').click(function(){
    	...
    	jQuery(this).closest('#edit_card_form').siblings('.error_messages').find('.alert_card_title').hide(500);
         ...
         jQuery(this).closest('#edit_card_form').siblings('.error_messages').find('.alert_html').hide(500);
          jQuery(this).closest('#edit_card_form').siblings('.error_messages').find('.alert_category').hide(500);
           jQuery(this).closest('#edit_card_form').siblings('.error_messages').find('.alert_keyword').hide(500);
    })
      ...
      if ((file = this.files[0])) {
          ...
          image.onload = function() {
              ...
              if(this.width < minwidth || this.height<minheight){
                ...
                jQuery(id).replaceWith($(id).val('').clone(true));
              }
              else{
				  //alert(image.src);
