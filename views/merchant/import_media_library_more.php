...
/**
 * @uses import more media library
...
?>
<div id="mediablockmore" style="display: none;">
			...
			<div class="message-box message-success" id="jqReviewHelpfulMessageNotification" >
				...
				<div  class="div_from_library">
					...
					?>
						...
						<div  align="center" >
							   <input type="button" class="save_btn disabledmedia" disabled='disabled' name="btn_save_from_library" id="btn_save_from_library" onclick="save_from_library_more()"  value="<?php echo $merchant_msg['index']['btn_save'];?>"/>
