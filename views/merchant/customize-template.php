<?php
/**
 * @uses customize templates
 * @used in pages : process.php,templates.php
...
<!---start header---->
  ...
  <div class="title_header"><?php echo $merchant_msg['templates']['Field_copy_template']; ?></div>
				 ...
				 <!-- <tr>
				  ...
				  <tr>
					...
					<td width="80%" align="left">
						<input type="text" name="title" id="title" size="50" placeholder="Required" onkeyup="changetext1()" maxlength="76" value="<?=$RS_t->fields['title']?>" /><span class="span_c1" >Maximum 76 characters | No HTML allowed</span>
					</td>
				  </tr>
				  <!--
                                  <tr>
					...
					<td width="80%" align="left">
						<input type="text" name="discount" id="discount" value="<?=$RS_t->fields['discount']?>" onkeyup="changetext2()" maxlength="8"/><span class="span_c2"  >Maximum 8 characters</span>
...
jQuery("#btnAddTemplate").click(function(){
