...
<html>
<head>
<title>ScanFlip | Add Location</title>
...
<body>
 ...
 <div >
	...
	<div id="contentContainer">
		<div id="content">  <h3><?php echo $merchant_msg["addlocation"]["Field_location_lable"];?></h3>
		<!--<p>Please fill out this form in order to add a new location.<br /> You can simply edit your location later on location list by clicking on edit button. </p> -->
		<p>Please tell us about your location - <span class='cls_bold'>* fields are required</span></p>
	<!--// 369--><form id="add_location_form" action="process.php"  method="post" enctype="multipart/form-data"><!-- id="add_location_form" >
		<!-- T_5 -->
		...
		<!-- T_5 -->
            <input type="hidden" name="hdn_image_path" id="hdn_image_path" value="" />
				...
				<div id="expanderContentAddress" style="display:none">
					...
					<td align="left">
						<!--<input type="text" name="address" id="address" class="input_location"/>-->
						<textarea name="address" id="address" class="location_address"></textarea>
					</td>
				  </tr>
				 
                                  <?php 
                                    //echo $RSBN->fields['state'];
                                    //echo $RSBN->fields['country'];
                                  ?>
                                  <tr style="display:none;">
					<td align="right"><?php echo $merchant_msg["addlocation"]["Field_country"];?> </td>
					<td align="left">
							<?php
								//echo $RSBN->fields['country']."-".$RSBN->fields['state']."-".$RSBN->fields['city'];
								$array_where = array();
							...
							<select name="country" id="country" >
							   ...
							   <?php
									if($RS_country->RecordCount()>0)
									{
										...
										{
										?>
											<option <?php if($Row['id']==$RSBN->fields['country']) {echo "selected";} ?> value="<?php echo $Row['id'] ?>"><?php echo $Row['name'] ?></option>
										<?php
										}
									}
									?>
				  ...
				  <tr>
					...
					<td align="left">
						<?php
		$array_where = array();
		$array_where['country_id'] = $RSBN->fields['country'];
		$array_where['active'] = 1;
	    ...
	    <select name="state" id="state" class="" style="display:block">
			...
			?>
				  ...
				  <tr>
					...
					<td align="left">
						<input type="text" name="zip" id="zip" class="input_location"/>
					</td>
				  </tr>
				  <tr>
					...
					<td align="left">
						...
						<!--<input type="text" name="phone_number" id="phone_number" />-->
                                                ...
                                                <input type="text" name="mobileno_area_code" id="mobileno_area_code" class="mobile_code1 " value="" maxlength="3">-
                                                <input type="text" name="mobileno2" id="mobileno2" class="mobile_code1" value="" maxlength="3">-
                                                <input type="text" name="mobileno" id="mobileno" class="mobile_code2" value="" maxlength="4">
					</td>
				  </tr>
					</table>
				</div>
				...
				<div id="expanderContentWeb" style="display:none">
					...
					<td align="left">
						<input type="text" placeholder="http://www.YourSite.com/LandingPage" name="website" id="website" class="input_location"/>
					</td>
				  </tr>
                                  <tr>
					<td align="right"><?php echo $merchant_msg["addlocation"]["Field_facebook"];?></td>
					<td align="left">
						<input type="text" placeholder="https://www.facebook.com/LandingPage" name="facebook" id="facebook" class="input_location"/>
					</td>
				  </tr>
                                  <tr>
					<td align="right"><?php echo $merchant_msg["addlocation"]["Field_google"];?></td>
					<td align="left">
						<input type="text" placeholder="https://plus.google.com/LandingPage"name="google" id="google" class="input_location"/>
					</td>
				  </tr>
				  ...
				  <tr>
					...
					<td align="left">
						<input type="text" name="email" id="email" class="input_location"/>
					</td>
				  </tr>
					</table>
				</div>
				...
				<div id="expanderContentLocation" style="display:none">
					<table width="100%"  border="0" cellspacing="2" cellpadding="2">
						<tr>
							...
							<td align="left">
														<input type="checkbox" name="chk_payment_method[]" value="Cash" id="Cash" /><label for="Cash" class='chk_align'><span><?php echo "Cash" ?></span></label>
								<input type="checkbox" name="chk_payment_method[]" value="Cash only" id="Cash only" /><label for="Cash only" class='chk_align'><span><?php echo "Cash only" ?></span></label>
								<input type="checkbox" name="chk_payment_method[]" value="Visa" id="Visa" /><label for="Visa" class='chk_align'><span><?php echo "Visa" ?></span></label>
								<input type="checkbox" name="chk_payment_method[]" value="Master card" id="Master card" /><label for="Master card" class='chk_align'><span><?php echo "Master card" ?></span></label>
								<input type="checkbox" name="chk_payment_method[]" value="AMEX" id="AMEX" /><label for="AMEX" class='chk_align'><span><?php echo "AMEX" ?></span></label>
								<input type="checkbox" name="chk_payment_method[]" value="Discover" id="Discover" /><label for="Discover" class='chk_align'><span><?php echo "Discover" ?></span></label>
								<input type="checkbox" name="chk_payment_method[]" value="Dinerclub" id="Dinerclub" /><label  for="Dinerclub" class='chk_align'><span><?php echo "Dinerclub" ?></span></label>
								<input type="checkbox" name="chk_payment_method[]" value="Paypal" id="Paypal" /><label for="Paypal" class='chk_align'><span><?php echo "Paypal" ?></span></label>
								<input type="checkbox" name="chk_payment_method[]" value="Square" id="Square" /><label for="Square" class='chk_align'><span><?php echo "Square" ?></span></label>
								<input type="checkbox" name="chk_payment_method[]" value="Debit card" id="Debit card" /><label for="Debit card" class='chk_align'><span><?php echo "Debit card" ?></span></label>
							</td>
						</tr>
						<tr>
							<td align="right">
						...
						<tr>
							...
							<td align="left">
								<textarea name="restrictions" id="restrictions" class="location_services_textarea" placeholder="Optional"></textarea>
						...
						<tr>
							...
							<td align="left" class="street-view">
								<input id="google_street_yes" type="radio" name="rdo_google_street" value="Yes" /><label for= "google_street_yes" class='chk_align'><?php echo "Yes" ?></label>
								<input id="google_street_no"  type="radio" name="rdo_google_street" value="No" /><label for= "google_street_no" class='chk_align'><?php echo "No" ?></label>
							</td>
						</tr>
						...
						<tr class="prk_cls">
							...
							<td align="left">
								<input type="checkbox" name="chk_parking[]" value="Garage" id="Garage" /><label for="Garage" class="chk_align"><?php echo "Garage" ?></label>
								<input type="checkbox" name="chk_parking[]" value="Lot" id="Lot" /><label for="Lot" class="chk_align"><?php echo "Lot" ?></label>
								<input type="checkbox" name="chk_parking[]" value="Street" id="Street" /><label for="Street" class="chk_align"><?php echo "Street" ?></label>
								<input type="checkbox" name="chk_parking[]" value="Valet" id="Valet" /><label for="Valet" class="chk_align"><?php echo "Valet" ?></label>
							</td>
						</tr>
						<tr>
							<td width="30%" align="right">Location Hours : <span class="notification_tooltip" title="<?php echo $merchant_msg["addlocation"]["Tooltip_Loction_Hours"]; ?>" >&nbsp;&nbsp;&nbsp</span></td>
							 <td align="left">
								 ...
								 <div class="addhoursdiv">
									 <input type="button" id="addhoursid" value="Add hours" class="add_hours" />
								...
								From <input id="defaultValueFrom" name="from" type="text" class=" time" />
										To <input id="defaultValueTo" name="to" type="text" class="time"/>
								 ...
								 <div class="add_hour_div">
									...
									<input type="button" id="addhourscancelid" value="<?php echo $merchant_msg['index']['btn_cancel'];?>" />
								 </div>
					...
					<td align="left">
						<div id="first_lc" >
						<select name="first_cat_first_level" id="first_cat_first_level" size="9" style="overflow:auto;">
						<?php
						...
						<select name="second_cat_first_level" id="second_cat_first_level" size="9" style="overflow:auto;">
						<?php
							/*$Sql = "SELECT * FROM category_level where parent_id=0 order by cat_name";
						...
						<select name="third_cat_first_level" id="third_cat_first_level" size="9"style="overflow:auto;">
						<?php
							/*$Sql = "SELECT * FROM category_level where parent_id=0 order by cat_name";
				...
				<table width="100%"  border="0" cellspacing="2" cellpadding="2">
				   <tr style="display:none;">
					...
					<td width="80%" align="left">
						<input type="text" name="location_name" id="location_name" value="<?php echo $RSBN->fields['business']; ?>"/>
...
<!--				  <tr>
				  ...
				  <tr>
					...
					<td class="location_save" align="center">
						<!-- T_5 -->
						<input type="submit" name="btnAddLocation" value="<?php echo $merchant_msg['index']['btn_save'];?>" id="btnAddLocation">
						<!--// 369-->
							...
							<!-- -->
							   ...
							   <div style="display: none;padding-left: 13px; padding-right: 13px;" class="div_from_computer">
								...
								<div  align="center" style="padding-top:10px">
                                                                    <input class="save_btn" type="button" name="btn_save_from_computer" id="btn_save_from_computer" onclick="save_from_computer()"  value="Save"/>
								</div>
							   </div>
...
//										while($Row = $RSImages->FetchRow()){
										...
										<li class="li_image_list" id="li_img_<?=$Row->id;?>">
											<div>
												<img src="<?php echo ASSETS_IMG ?>/m/location/<?php echo $Row->image;  ?>" height="50px" width="50px" />
								...
								<div  align="center" style="padding-top:10px">
										...
										<input type="button" class="save_btn" name="btn_save_from_library" id="btn_save_from_library" onclick="save_from_library()"  value="Save"/>
									</div>
							   </div>
							   <?php
									}
...
jQuery(function(){
		...
		new AjaxUpload(btnUpload, {
			...
			onComplete: function(file, response){
                ...
                var btnUpload=jQuery('#upload_more');
                var uploading=jQuery('#uploading_msg_more');
			...
			onComplete: function(file, response){
				...
				if(arr[1]=="small")
                                ...
                                else
                                {
                                   ...
                                   // jQuery('<li style="list-style:none" id="li_'+arr[0]+'"></li>').appendTo('#files_more').append(img +"<div style='margin-top: 10px; display:table;float:left;width:48px;height:65px;'><img src='<?=ASSETS_IMG ?>/m/large_close.png' id='"+file_path+"' class='cancel_remove_image' onclick='rm_image_more(this.id)' /></div><input type='hidden' name='hdn_more_images[]' value='"+ file_path +"' /></div>");	
                                  jQuery('<li style="list-style:none" id="li_'+arr[0]+'"></li>').appendTo('#files_more').append(img +"<a href='javascript:void(0)' id='"+file_path+"' class='closebuttonclass' onclick='rm_image_more(this.id)' ></a><input type='hidden' name='hdn_more_images[]' value='"+ file_path +"' /></div>");	 
...
alert(e);
 ...
 $('#add_location_form').ajaxForm({ 
        beforeSubmit:processLoginorNot,
    
        dataType:  'json',
       success:   processAddLocaJson 
...
function processAddLocaJson(data) { 
	if(data.status == "true"){
...
function save_from_library()
{
	 ...
	 else
	 {
		...
		$av("#hdn_image_id").val(sel_val);
           ...
           var sel_src = $av(".fancybox-inner #li_img_"+sel_val+" span[id=span_img_text_"+sel_val+"]").text();
            //var sel_src = $av("#li_img_"+sel_val).find('img').attr('src');
    ...
    //var img ="<img src='"+sel_src+"' class='displayimg'>";
				...
				if(arr_media[0]=="success")
                                {
									...
									*/
                                       ...
                                       {
                                           jQuery("#status_more").html("This image alreday uploaded.");
                                       }
			}
		});
...
function save_from_computer()
{
	...
	jQuery('#files').html(img +"<br/><div style='display:table'><div style='display:table-row;'><div style='display:table-cell;'><img src='<?=ASSETS_IMG ?>/m/mediya_delete.png' class='cancel_remove_image' onclick='rm_image_parmanent(this.id)' id='"+file_path+"' /></div></div></div>");
}


jQuery("#btnAddLocation").click(function(){
					...
					*/
					...
					if(parkingcount==0)
					{
					 ...
					 jQuery.ajax({
                           type:"POST",
                           url:'process.php',
                           data :'checkprimarylocation=yes&checkboxvalue='+p_status,
                          async:false,
                           success:function(msg)
                           {
     ...
     jQuery('#addhourssaveid').click(function(){
       ...
       jQuery("#"+weekname+"hdn").attr("to",to);
        ...
        //alert(from + to + checkboxval);
                jQuery(".hoursdata").append("<div style='float:left;width:100%;' id='"+jQuery(this).val()+"'><div style='width: 82%;float: left;line-height:40px;'><span id='dis_"+ checkboxval +"'>From : " + from.toUpperCase() +" To : " + to.toUpperCase() + " - "+ checkboxval+"</span></div><div style='float: left;width:16%;'><a href='javascript:void(0)'  class='removeclass closebuttonclass' id='remove_"+ checkboxval+"'></a></div><div>");
