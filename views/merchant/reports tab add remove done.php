			...
			else
			{
		        ...
		        $(document).ready(function () {
					  ...
					  //data table function on pricelist index page table
						...
						//jQuery("#btnfilterLoyaltyCards_revenue").live("click",function(){
						...
						//jQuery("#btnfilterLoyaltyCards_byage").live("click",function(){
						...
						//jQuery("#btnfilterLoyaltyCards_bytime").live("click",function(){
