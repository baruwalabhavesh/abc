...
/**
 * @uses add templates
 * @used in pages : add-user.php,edit-user.php,process.php,templates.php
...
<html>
<head>
<title>ScanFlip | Add Template</title>
...
$(document).ready(function() { 
    ...
    $('#add_template_form').ajaxForm({
        
         beforeSubmit:processLoginorNot,
        dataType:  'json', 
        success:   processAddTempJson 
    });
	
	
});
function processAddTempJson(data) { 
...
<!---start header---->
  ...
  <h3><?php echo $merchant_msg['templates']['Field_add_template']; ?></h3>
  <!-- <p>Please fill out this form in order to add a new template. And use this template to create campaign .<br /> You can simply edit your template later on template list by clicking on edit button. </p> -->
	<!--// 369--><form action="process.php" method="post" enctype="multipart/form-data" id="add_template_form">
		<input type="hidden" name="hdn_redirectpath" id="hdn_redirectpath" value="<?=WEB_PATH.'/merchant/templates.php'?>" />
				...
				<table width="100%"  border="0" cellspacing="2" cellpadding="2" id="table_spacer">
				  ...
				  <tr>
					...
					<td width="80%" align="left">
						<input type="text" name="title" id="title" size="50" onkeyup="changetext1()" placeholder="Required"  maxlength="76"/><span class="span_c1" >Maximum 76 characters | No HTML allowed</span>
					</td>
				  </tr>
				 <!--
                   <tr>
					...
					<td width="20%" align="left">
						<input type="text" name="discount" id="discount" onkeyup="changetext2()" maxlength="8"/>
...
<!--				  <tr>
				  ...
				  <tr>
					...
					<textarea id="description" name="description" rows="15" cols="80" class="table_th_80"></textarea>
					...
					<div class="textarea_container" style="display: none;">
					<textarea id="terms_condition" name="terms_condition" rows="15" cols="80" class="table_th_80"></textarea>
                    	</div>
<!--<input type="hidden" name="hdndescription" id="hdndescription" value="" />-->
					...
					<td align="left">
					<textarea id="print_coupon_description" name="print_coupon_description" rows="10" cols="40" style="width: 80%"></textarea>
				  ...
				  <tr>
					<td>&nbsp;</td>
					<td align="left">
						<input type="submit" name="btnAddTemplate" value="<?php echo $merchant_msg['index']['btn_save'];?>" onClick="mycall();" id="btnAddTemplate">
						<!--// 369--><script>
                                                    function btncanTemplate(){                                                
						...
						<input type="submit" name="btnCancel" id="btnCancel" value="<?php echo $merchant_msg['index']['btn_cancel'];?>" onClick="btncanTemplate()">
                        <!--// 369-->
					</td>
				  </tr>
				</table>
...
//										while($Row = $RSImages->FetchRow()){
										$arr=file(WEB_PATH.'/merchant/process.php?btnGetLogosOfMerchant=yes&mer_id='.$_SESSION['merchant_id']."&img_type=template&mer_parent_id=".$merchant_info->fields['merchant_parent']."&start_index=0&num_of_records=12");
										if(trim($arr[0]) == "")
										{
											unset($arr[0]);
						...
						<img src="<?php echo ASSETS_IMG ?>/m/campaign/<?php echo $Row->image;  ?>" height="50px" width="50px" />
    ...
    var flag="true";
     ...
     var t_name=jQuery("#title").val();        
        jQuery.ajax({
                           type:"POST",
                           url:'process.php',
                           data :"check_template_name_exist=yes&template_name="+ t_name +"&mer_id=<?php echo $_SESSION['merchant_id']; ?>",
                          async:false,
                           success:function(msg)
                           {
...
$("a#templates").css("background-color","orange");
</script>
