...
$RS = $objDB->Conn->Execute('select SQL_CALC_FOUND_ROWS * from rewardzone_campaigns where id= ? AND merchant_id=? AND is_deleted=?', array($_REQUEST['id'], $_SESSION['merchant_id'], 0));
if ($RS->RecordCount() > 0) {
    ...
    <body>
        ...
        <div >
            ...
            <div id="contentContainer">
                <div id="content">   <div class="title_header"><?php echo $merchant_msg["edit-compaign"]["Field_edit_campaign"]; ?></div>

                    <form action="process.php" method="post" enctype="multipart/form-data" id="add_rew_campaign_form">

                        <input type="hidden" name="hdn_image_path" id="hdn_image_path" value="<?php echo $RS->fields['image']; ?>" />
                        ...
                        <table width="100%"  border="0" id="table_spacer">
                            <tr>
                                ...
                                <td width="79%" align="left"><input type="text" placeholder="Required" name="title" id="title" maxlength="76" size="50" value="<?php echo $RS->fields['title']; ?>"/><span class="span_c1" >Maximum 76 characters | No HTML allowed</span></td>  
                            </tr>
                            <tr>
                                <td width="21%" align="right">
                                    <?php echo $merchant_msg["edit-compaign"]["Field_campaign_tag"]; ?>
                                </td>
                                <td width="79%" align="left"><input type="text" placeholder="Enter upto 3 keywords separated by commas " name="campaign_tag" id="campaign_tag"   size="50" value="<?php echo $RS->fields['keywords']; ?>"  /> <span data-toggle="tooltip" data-placement="right" class="notification_tooltip"  data-toggle="tooltip"  title="<?php echo $merchant_msg["edit-compaign"]["Tooltip_Campaign_Tag"]; ?>">&nbsp;&nbsp;&nbsp;</span></td>  
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <input type="text" name="deal_value" id="deal_value" placeholder="00" size="25" value="<?php echo $RS->fields['value']; ?>" /><span class="notification_tooltip"  data-toggle="tooltip" data-placement="right" title="<?php echo $merchant_msg["edit-compaign"]["Tooltip_deal_value"]; ?>" >&nbsp;&nbsp;&nbsp</span><span id="numeric">numeric, no currency symbol</span>
                                </td>
                            </tr> 
                            <tr>
                                <td width="21%" align="right"><?php echo $merchant_msg["edit-compaign"]["Field_deal_discount"]; ?> </td>
                                <td width="79%" align="left">
                                    <input type="text" name="campaign_disc_value" id="campaign_disc_value" placeholder="Optional" value="<?php echo $RS->fields['discount']; ?>">
                                ...
                                <td align="left">
                                    <select name="category_id" id="category_id" required="">
                                        ...
                                        while ($Row = $RSCat->FetchRow()) {
                                                ?>
                                                <option value="<?= $Row['id'] ?>" <?php echo ($RS->fields['category_id'] == $Row['id']) ? 'selected' : '' ?>><?= $Row['cat_name'] ?></option>
                                                <?php
                                        }
                                        ?>
                            ...
                            <tr><td align="right">&nbsp; </td>
                                <td>
                                    ...
                                    <ul id="files" class="pull-left">
                                        <img src='<?= ASSETS_IMG ?>/m/mediya_delete.png' onclick="rm_image_lib()" class='delete_imag01' />
                                        <img src="<?php echo ASSETS_IMG . '/m/campaign/' . $RS->fields['image']; ?>" class="displayimg" />
                            ...
                            <tr>
                                ...
                                <td align="left" class="textare_td" >
                                    ...
                                    <div class="textarea_container">	
                                        <textarea id="description" name="description" rows="15" cols="80" class="table_th_90"><?php echo $RS->fields['description']; ?></textarea>
                                    </div>
                                    <?php
                                           $rc= 1200 - strlen($RS->fields['description']);
                                            ?>
                                    <span id="desc_limit">Maximum <?php echo $rc; ?> characters | no HTML allowed</span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="left" class="textare_td">
                                    ...
                                    <div class="textarea_container" style="display: none;">	
                                        ...
                                        <textarea id="terms_condition" name="terms_condition" rows="15" cols="80" class="table_th_90"><?php echo $RS->fields['terms_cond']; ?></textarea>
                                    </div>
                                    <?php
                                           $trc= 1200 - strlen($RS->fields['terms_cond']);
                                            ?>
                                    <span id="terms_limit">Maximum <?php echo $trc; ?> characters | no HTML allowed</span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td align="left">
                                    <input type="submit" name="btneditRewardAddCampaigns" id="btneditRewardAddCampaigns" value="<?php echo $merchant_msg['index']['btn_save']; ?>" >
...
//Add uploaded file to list
                ...
                function save_from_library()
                {
                    ...
                    else
                    {
                        ...
                        //$('#files').html(img + "<br/><div style='margin-top: 10px; display:table'><div style='display:table-row;'><div style='display:table-cell;'><img src='<?= ASSETS_IMG ?>/m/delete.gif' id='' class='cancel_remove_image' onclick='rm_image_lib()' /></div></div></div>");
                ...
                function save_from_computer()
                {
                    ...
                    //$('#files').html(img + "<br/><div style='margin-top: 10px; display:table'><div style='display:table-row;'><div style='display:table-cell;'><img src='<?= ASSETS_IMG ?>/m/delete.gif' id='" + $("#hdn_image_path").val() + "' class='cancel_remove_image' onclick='rm_image(this.id)' /></div></div></div>");
                    $('#files').html("<img src='<?= ASSETS_IMG ?>/m/mediya_delete.png' id='' class='delete_imag01' onclick='rm_image_lib()'/>"+img);
                }
        </script>
    </body>
