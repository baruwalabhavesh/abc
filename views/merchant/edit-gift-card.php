<?php
/**
 * @uses edit gift card in reward zone.
 * @used in pages : 
 * @author Sangeeta Raghavani
 */
check_merchant_session();

$card = $objDB->Conn->Execute("Select * from giftcards where merchant_id=? and id=?", array($_SESSION['merchant_id'], $_GET['id']));
if ($card->RecordCount() > 0) {
        ...
        <html>
            <head>
                <title>ScanFlip | Edit Gift Card</title>
        ...
        <!--                <script type="text/javascript" src="<?= ASSETS ?>/tinymce/tiny_mce.js"></script>-->
            ...
            <body>
                ...
                ?>
                <div id="content">
                    <div class="title_header">Edit Gift Card</div>
                    <div>
                        <span class="span_error_msg" style="color:#FF0000; "></span>
                    </div>
                    <form action="process.php" method="post" class="gift_card08">
                        <input type="hidden" name="hdn_image_path" id="hdn_image_path" value="<?php echo $def_card['image']; ?>">
				...
				<!--<tr>
                                    ...
                                    <td width="80%" align="left">
                                        <input type="text" name="title" id="title" class="gift_card_input" value="<?php //echo $def_card['title']; ?>" placeholder="Required" required >
                                    </td>
                                </tr>-->
                                <tr>
                                    <td width="20%" align="right">Gift Card Keywords : </td>
                                    <td width="80%" align="left">
                                        <input type="textarea" name="keywords" id="keywords" class="gift_card_input" value="<?php echo $def_card['keywords']; ?>" placeholder="keywords separated by commas ">
                                        ...
                                        if ($Plans->RecordCount() > 0) {
                                                ...
                                                <select name="giftcard_value" id="giftcard_value" required>
                                                    ...
                                                    for ($i = $min; $i <= $max; $i +=$inc) {
                                                            ?>
                                                            <option value="<?php echo $i; ?>" <?php echo ($def_card['card_value'] == $i) ? 'selected' : ''; ?>><?php echo $i . ' ' . $curr; ?></option>
                                                            <?php
                                                    }
                                                    ?>
                                                </select>
                                ...
                                <tr>
                                    ...
                                    <td width="80%" align="left">
                                        <input type="text" name="giftcard_disc_value" id="giftcard_disc_value" placeholder="Optional" value="<?php echo $def_card['discount']; ?>">
                                        <select id="is_per" name="is_per">
                                            <option value="1" <?php echo ($def_card['is_per'] == 1) ? 'selected' : ''; ?>>% OFF</option>
                                            <option value="0" <?php echo ($def_card['is_per'] == 0) ? 'selected' : ''; ?>>$ OFF</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left">
                                        <select name="category_id" id="category_id">
                                            ...
                                            while ($Row = $RS->FetchRow()) {
                                                    ?>
                                                    <option value="<?= $Row['id'] ?>" <?php echo ($def_card['category_id'] == $Row['id']) ? 'selected' : ''; ?>><?= $Row['cat_name'] ?></option>
                                                    <?php
                                            }
                                            ?>
                                        </select>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <div class="browse_right_content">
                                            ...
                                            <span data-toggle="tooltip" data-placement="right" class="notification_tooltip" title="" data-html="true" data-original-title="Gift Card images uploaded must be at least 600 pixel x 300 pixel ( width x height )." style="display: none;">&nbsp;&nbsp;&nbsp; </span></div>
                                    </td>
                                </tr>
						...
						<?php if(!empty($def_card['image'])){ ?>
                                            <img src='<?= ASSETS_IMG ?>/m/mediya_delete.png' onclick="rm_image()" class='delete_imag01' />
                                            <img src='<?= ASSETS_IMG ?>/a/giftcards/<?php echo $def_card['image']; ?>' class='displayimg' />
						<?php } ?>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <div class="textarea_container">
                                            <?php
                                            $rc= 1200 - strlen($def_card['description']);
                                            ?>
                                            <textarea id="description" name="description" rows="15" cols="80" style="width: 80%"><?php echo $def_card['description']; ?></textarea>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td align="left"><input type="submit" name="btnUpdateGiftCard" id="btnUpdateGiftCard" value="Update">
