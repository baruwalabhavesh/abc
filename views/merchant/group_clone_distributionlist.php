<?php
/**
 * @uses group clone distribution list
...
$RS = $objDB->Show("merchant_groups", $array_where);
...
if(isset($_REQUEST['btnImportCustomers'])){
	...
	$_SESSION['msg']= "Customer(s) has been imported Successfully";
...
<html>
<head>
<title>ScanFlip | Copy Customer List</title>
...
<div>
	<!--<script src="<?=WEB_PATH?>/admin/js/jquery.js"></script>-->
        ...
        <!--<script src="<?=ASSETS_JS ?>/m/jquery-1.7.2.min.js"></script>-->
        <!-- load from CDN-->
...
<!---start header---->
	...
	<div id="content">
  <div class="title_header">Copy Customer List</div>
            ...
            <table width="100%" class="main_import">
                <tr class="tr_top">
                    <td>
                        ...
                        <div class="td_right">
                            <input type="text" name="group_name" id="group_name" value="<?php echo "Copy of ".$RS->fields['group_name']; ?>" />&nbsp;&nbsp;
                    ...
                    <td>
                        ...
                        <div class="td_right">
                            ...
                            <select name="location_name" id="location_name" >
                                <?php
                                   $result1=mysql_query("SELECT * from locations where active=1 and created_by=".$_SESSION['merchant_id']);
                                   while($Row= mysql_fetch_array($result1)) 
                                   { ?>
                                      <option value="<?=$Row['id']?>" <?php if($RS->fields['location_id']==$Row['id']){ echo "selected"; } ?> >
										<?php
										/*										
		...
		<div class="csv_border">
			...
			<input type="submit" class="btn btn-success" name="download_csv" id="download_csv" value="Download" >
              ...
              <tr  class="tr_top">
                  <td>
                       <div  class="tr_top">
                        <input type="submit" class="btn btn-success" name="Import_user_clone" id="Import_user_clone" value="<?php echo $merchant_msg['index']['btn_save'];?>" />&nbsp;&nbsp;
                        
                        <input type="submit" class="btn btn-success" name="btnCanDistributionlist" id="btnCanDistributionlist" value="<?php echo $merchant_msg['index']['btn_cancel'];?>" />
                    </div> 
                  </td>
              </tr>
...
$(function(){
    ...
    $("#Import_user_clone").click(function(){
	...
	var msg_box="";
        ...
        $.ajax({
				...
				success: function(msg) {
                                    ...
                                    {
                                        //$(".span_error_msg").text("Please Choose Different Name");
					msg_box +="Distribution list already exist. Please enter different name for distribution list.";
                                        flag = false;
                   ...
                   {
                     //$(".span_error_msg").text("Enter Distribution List Name");
		     msg_box +="Enter Distribution List Name.";
                     flag = false;
                   }
                   if(flag)
                   {
