...
if(isset($_REQUEST['btn_filter_loyalty_card_metrics']))
{
	...
	if(isset($_REQUEST['opt_filter_days'])) // after filter
	{
		...
		*/  
		$arr = file(WEB_PATH . '/merchant/process.php?create_loyalty_metrics_view=yes&merchant_id=' . $merchant_id . '&card_id=' . $card_id);
		if (trim($arr[0]) == "") {
				unset($arr[0]);
		...
		$RS =  $objDB->Conn->Execute("select * from `card_".$card_id."_metrics_".$days."days`");
			                 
		//if($RS->RecordCount()>0 && $RS->fields['total_cards_activated']>0 && $RS->fields['total_cards_rewarded']>0 && $RS->fields['total_cards_deleted']>0)
		if($RS->fields['total_cards_activated']>0 && $RS->fields['total_cards_rewarded']>0 && $RS->fields['total_cards_deleted']>0)
		{
		...
		$total_male_activated_cards = $RS->fields['total_male_activated_cards'];
		$total_female_activated_cards = $RS->fields['total_female_activated_cards'];
		
		$total_male_activated_desktop_cards = $RS->fields['total_male_activated_desktop_cards'];
		$total_male_activated_mobile_cards = $RS->fields['total_male_activated_mobile_cards'];
		$total_male_activated_qr_cards = $RS->fields['total_male_activated_qr_cards'];
		
		$total_female_activated_desktop_cards = $RS->fields['total_female_activated_desktop_cards'];
		$total_female_activated_mobile_cards = $RS->fields['total_female_activated_mobile_cards'];
		$total_female_activated_qr_cards = $RS->fields['total_female_activated_qr_cards'];
		
		// rewarded
		
		$total_cards_rewarded = $RS->fields['total_cards_rewarded'];
		$total_male_rewarded_cards = $RS->fields['total_male_rewarded_cards'];
		$total_female_rewarded_cards = $RS->fields['total_female_rewarded_cards'];
		
		$total_male_rewarded_desktop_cards = $RS->fields['total_male_rewarded_desktop_cards'];
		$total_male_rewarded_mobile_cards = $RS->fields['total_male_rewarded_mobile_cards'];
		$total_male_rewarded_qr_cards = $RS->fields['total_male_rewarded_qr_cards'];
		
		$total_female_rewarded_desktop_cards = $RS->fields['total_female_rewarded_desktop_cards'];
		$total_female_rewarded_mobile_cards = $RS->fields['total_female_rewarded_mobile_cards'];
		$total_female_rewarded_qr_cards = $RS->fields['total_female_rewarded_qr_cards'];
		
		// deleted
		
		$total_cards_deleted = $RS->fields['total_cards_deleted'];
		$total_male_deleted_cards = $RS->fields['total_male_deleted_cards'];
		$total_female_deleted_cards = $RS->fields['total_female_deleted_cards'];
		
		$total_male_deleted_desktop_cards = $RS->fields['total_male_deleted_desktop_cards'];
		$total_male_deleted_mobile_cards = $RS->fields['total_male_deleted_mobile_cards'];
		$total_male_deleted_qr_cards = $RS->fields['total_male_deleted_qr_cards'];
		
		$total_female_deleted_desktop_cards = $RS->fields['total_female_deleted_desktop_cards'];
		$total_female_deleted_mobile_cards = $RS->fields['total_female_deleted_mobile_cards'];
		$total_female_deleted_qr_cards = $RS->fields['total_female_deleted_qr_cards'];
		...
		// start for revenue
		echo WEB_PATH . '/merchant/process.php?create_loyalty_revenue_view=yes&merchant_id=' . $merchant_id . '&card_id=' . $card_id;
		$arr = file(WEB_PATH . '/merchant/process.php?create_loyalty_revenue_view=yes&merchant_id=' . $merchant_id . '&card_id=' . $card_id);
		if (trim($arr[0]) == "") {
				unset($arr[0]);
				$arr = array_values($arr);
		}
		...
		$RS1 =  $objDB->Conn->Execute("select * from `card_".$card_id."_revenue_".$days."days`");
