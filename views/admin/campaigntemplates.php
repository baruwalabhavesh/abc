...
<body>
	...
	<tr><td><a href="add-defaulttemplate.php"><img src="<?php echo ASSETS_IMG; ?>/a/icon-add.png"></a></td>
		...
		<td><?=$Row['description']?></td>
		    ...
		    <td align="left">
			<a href="edit-defaulttemplate.php?id=<?=$Row['id']?>">Edit</a>
                        <a href="campaigntemplates.php?id=<?=$Row['id']?>&action=delete">Delete</a>
			</td>
		  </tr>
		  <?
		  }
		  ...
		  ?>
		  <tr>
			<td colspan="3" align="left">No Default campaign template is Found.</td>
		  </tr>
		  <?
		  }
		  ?>
