...
$RS = $objDB->Show("country", $array_where);
?>
		...
		<table width="100%" align="center"  border="0" cellspacing="2" cellpadding="2" class="tableAdmin">
		  <tr>
	       ...
	       <tr>
			...
			<th width="60%" align="left"><?php echo $RS->fields['name'] ?></th>
		  </tr>
		  <tr>
		  ...
		  <tr>
			<th width="40%" align="right">State Code: </th>
			<th width="60%" align="left"><input type="text" name="short_form" /></th>
		  </tr>
		  ...
		  <tr>
			<td>&nbsp;</td>
			<td align="left">
			<input type="hidden" id="country_id" name="country_id" value="<?php echo $_REQUEST['id']; ?>" />	
			<input type="submit" name="btnAddState" value="Save" />
