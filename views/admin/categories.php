...
if(isset($_REQUEST['active']))
{
    ...
    $objDB->Update($array_values, "categories", $where_clause);
}
...
<body>
	...
	<tr><td><a href="add-category.php"><img src="<?php echo ASSETS_IMG; ?>/a/icon-add.png"></a></td>
	...
	<td><a href="#"><img src="<?php echo ASSETS_IMG; ?>/a/icon-delete.png"></a></td>-->
		...
		<table width="100%"   class="tableAdmin">
		  ...
		  <tr>
			...
			<th width="40%" align="left">Category Image</th>
		  ...
		  <tr>
			...
			<td align="left"><?=$Row['cat_scroller_image']?></td>
			<td align="left">
			<?
			echo $Row['orders'];
			?>
			...
			<a href="edit-category.php?id=<?=$Row['id']?>">Edit</a>&nbsp;|&nbsp;
                            ...
                            <?php
                                ...
                                {
                            ?>
                                    <a href="categories.php?active=0&id=<?=$Row['id']?>">Deactivate</a>        
                            <?php                                  
                                }
                                else
                                {
                                ?>
                                    <a href="categories.php?active=1&id=<?=$Row['id']?>">Activate</a>        
                            <?php
                                }
                            ?>
                        </a>
		  ...
		  ?>
		  <tr>
			<td colspan="4" align="left">No Category is Found.</td>
		  </tr>
		  <?
		  }
		  ?>
