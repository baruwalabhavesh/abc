	...
	<form action="process.php" method="post">
		<table width="100%" align="center"  border="0" cellspacing="2" cellpadding="2" class="tableAdmin">
		  ...
		  <tr>
			...
			<th width="60%" align="left"><input type="text" name="cat_name" /></th>
		  </tr>
		   <tr>
			<th width="40%" align="right">Category Image In Search Deal Block: </th>
			<th width="60%" align="left"><input type="text" name="cat_image" value="" size="60"/></th>
		  </tr>
		   <tr>
			<th width="40%" align="right">Category Image On Scroller: </th>
			<th width="60%" align="left"><input type="text" name="cat_scroller_image" value="" size="60"/></th>
		  </tr>
		   <tr>
			<th width="40%" align="right">Category Active Image On Scroller: </th>
			<th width="60%" align="left"><input type="text" name="cat_scroller_image_active" value="" size="60"/></th>
		  </tr>
		   <tr>
			<th align="right">Order: </th>
			<th align="left"><input type="text" name="order" size="5" /></th>
		  </tr>
		 
		  <tr>
			<td>&nbsp;</td>
			<td align="left">
			<input type="submit" name="btnAddCategory" value="Save" />
