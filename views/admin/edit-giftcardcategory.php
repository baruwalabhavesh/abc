...
$RS = $objDB->Show("giftcard_categories", $array_where);
?>
		...
		<table width="50%" align="center"  border="0" cellspacing="2" cellpadding="2" class="tableAdmin">
		 ...
		 <tr>
		  ...
		  <tr>
			...
			<input type="submit" name="btnEditgiftcardCategoryYes" value="Save" />
                        <input type="submit" name="cangiftcat" value="Cancel" />
			</td>
		  </tr>
