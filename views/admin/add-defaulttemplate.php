    ...
    <div id="container">
        ...
        <div id="contentContainer">
          ...
          <tr>
                               ...
                               <td width="80%" align="left">
                                       <input type="text" name="discount" id="discount" onkeyup="changetext2()" maxlength="8"/><span class="span_c2"  >Maximum 8 characters</span><span class="notification_tooltip"  title="Please enter Save $2, $2 OFF , 20% OFF etc. to highlight discount on your campaign for web and mobile devices.">&nbsp;&nbsp;&nbsp;</span>
                               </td>
 ...
 <!-- <input type="file" name="business_logo" id="business_logo" />-->
        ...
        <!--<input type="hidden" name="hdndescription" id="hdndescription" value="" />-->
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <textarea id="terms_condition" name="terms_condition" rows="15" cols="80" style="width: 80%"></textarea>
            <!--<input type="hidden" name="hdndescription" id="hdndescription" value="" />-->
        ...
        <tr>
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td align="left">
                                <input type="submit" name="btnAddTemplate" value="Save" >
                                <!--// 369-->
