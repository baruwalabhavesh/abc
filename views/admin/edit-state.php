...
$RS = $objDB->Show("state", $array_where);
?>
	...
	<form action="process.php" method="post">
		<table width="100%" align="center"  border="0" cellspacing="2" cellpadding="2" class="tableAdmin">
		  ...
		  <tr>
			...
			<th width="60%" align="left"><input type="text" name="short_form" value="<?=$RS->fields['short_form']?>" /></th>
		  </tr>
		  ...
		  <tr>
			...
			<input type="submit" name="btnEditState" value="Save" />
