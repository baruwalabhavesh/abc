...
$RS = $objDB->Show("emailtemplate", $array_where);
?>
	...
	<div  id="sidebarLeft">
		...
		<table border="0" cellspacing="2" cellpadding="2" class="">
		  ...
		  <tr>
			...
			<td width="60%" align="left"><input type="text" name="key" style="width:50%" value="<?=$RS->fields['template_key']?>" disabled /></td>
		  </tr>
                    <tr>
			<td align="right">Subject: </td>
			<td align="left"><input type="text" name="subject" style="width:96%" value="<?=$RS->fields['subject']?>"/></td>
		  </tr>
		  <tr>
			<td width="40%" align="right">Message/Body:</td>
                       <td width="60%" align="left"><textarea name="value" id="value" style="width: 40% !important;" cols="40" rows="15" ><?=htmlentities($RS->fields['value'])?></textarea><br /></td>
		  </tr>
		  ...
		  <tr>
			...
			<input type="submit" name="btnEditEmailtemplate" value="Save" />
