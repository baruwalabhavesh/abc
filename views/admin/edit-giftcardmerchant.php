...
$RS = $objDB->Show("giftcard_merchant_user", $array_where);
?>
	...
	<form action="process.php" method="post">
		<table width="50%" align="center"  border="0" cellspacing="2" cellpadding="2" class="tableAdmin">
		  ...
		  <tr>
			...
			<th width="60%" align="left"><input type="text" name="cat_name" value="<?=$RS->fields['merchant_name']?>" /></th>
		  </tr>
		  ...
		  <tr>
			...
			<input type="submit" name="btnEditgiftcardMerchantYes" value="Save" />
