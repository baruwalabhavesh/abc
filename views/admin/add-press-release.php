        ...
        <div id="contentContainer">
                    ...
                    <table border="0" cellspacing="2" cellpadding="2" style="width:100%;" >
                        <tr>
                            ...
                            <td width="60%" align="left">
                                <input type="text" name="title" id="title" style="width:inherit;"/>
                            </td>
                        </tr>
            ...
            <!--<input type="hidden" name="hdndescription" id="hdndescription" value="" />-->
                        ...
                        <tr>                                  
                            ...
                            <td align="left">
                                <input type="text" name="release_date" class="datetimepicker_sd" id="release_date" style="width:100px; " value="">
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td align="left">
                                <input type="submit" name="btnAddPressrelease" value="Save" >
                                <!--// 369-->
