...
$RS = $objDB->Show("point_packages", $array_where);
?>
...
<!--		  <tr>
			<th width="40%" align="right">Package Name:</th>
                        <th width="60%" align="left"><input type="text" name="pac_name" value="<?=$RS->fields['package_name']?>" /></th>
		  </tr>-->
		  <tr>
			<th width="40%" align="right">Conversation Rate: </th>
                        <th width="60%" align="left"><input type="text" name="pac_prize" value="<?=$RS->fields['price']?>" /></th>
		  </tr>
		  
		  <tr>
			<th align="right">Points: </th>
                        <th align="left"><input type="text" name="points" size="5" value="<?=$RS->fields['points']?>" /></th>
		  </tr>
		  <tr>
			<td>&nbsp;</td>
			<td align="left">
                        <input type="hidden" name="id" value="<?=$RS->fields['id']?>" />
			<input type="submit" name="btnupdatepointpac" value="Save" />
