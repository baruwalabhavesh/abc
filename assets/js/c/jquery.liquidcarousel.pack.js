    ...
    $.fn.liquidcarousel = function (options) {
        ...
        return this.each(function () {
           ...
           // $('> .wrapper > ul > li', divobj).height(options.height);
            ...
            var liwidth = $('> .wrapper > ul > li:last', divobj).outerWidth(true);
			if($('> .wrapper > ul > li:last', divobj).hasClass("current"))
			{
          ...
          /* alert("total"+totalwidth);*/
			...
			//	$('.wrapper').css("width", availablewidth);
               /* alert( availablewidth+"div width");*/
                previousvisiblelis = visiblelis;
                visiblelis = Math.floor((availablewidth / liwidth));
				/*alert(visiblelis+"visible lis==="+totallis+"total lis");*/
			...
			//	liwidth=liwidth-1;
				...
				//liwidth=liwidth+1;
                    additionalmargin = Math.floor((availablewidth - (totallis * liwidth)) / totallis)
					 halfadditionalmargin = Math.floor(additionalmargin / 2);
					  halfadditionalmargin = halfadditionalmargin -1;
                }
               
				/*alert(halfadditionalmargin+"half");
				alert(originalmarginright +"original");*/
